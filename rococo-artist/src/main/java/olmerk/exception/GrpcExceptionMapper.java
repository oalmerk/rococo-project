...
public final class GrpcExceptionMapper {
    ...
    public static RuntimeException map(DataIntegrityViolationException ex, String entityName, String uniqueValue) {
        if (isUniqueViolation(ex)) {
            return Status.ALREADY_EXISTS
                    .withDescription(entityName + " with name '" + uniqueValue + "' already exists")
                    .asRuntimeException();
        }
    ...
    public static RuntimeException map(ArtistNotFoundException ex) {
